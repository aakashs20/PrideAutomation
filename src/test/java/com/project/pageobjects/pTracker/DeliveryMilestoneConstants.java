...
public class DeliveryMilestoneConstants {
	public static final String ACTIVE_PROJECTS_LIST = "//*[@id='active_tab']/a/span[contains(text(),'Active Projects')]";
	public static final String SELECT_ROLE_RELEASE_DROPDOWN_BUTTON = "//*[@id='P8_SEL_ROLE_lov_btn']"; 
	public static final String PROCEED_BUTTON = "//*[@id='B77297519692893844'][contains(text(),'Proceed')]"; 
	public static final String FIXED_PRICE = "//*[@id='R505691641167493060_cards']/li[1]"; 
	public static final String SELECT_ROLE_RELEASE_NAME = "//*[@id='PopupLov_8_P8_SEL_ROLE_dlg']//li[contains(text(),'Release 10 - Project Management')]"; 
	public static final String PROJECT_TYPE = "//*[@id='ap_top_region']//span[contains(text(),'Project Type')]"; 
	...
	public static final String PROJECT_NUMBER = "//*[@id='report_table_projects-active-report']//a[contains(text(),'A2CO0010')]"; 
	public static final String PROJECT_NUMBER_TITLE = "//*[@id='R382922062436694454']//span[contains(text(),'A2CO0010')]"; 
	...
	public static final String REQUEST_DATE_PICKER = "//*[@id='P89_REQUEST_DATE_CONTAINER']/div[2]/div/button";
	public static final String MONTH_REQUEST_DATE = "//*[@id='ui-datepicker-div']//select[@class='ui-datepicker-month']";
	public static final String YEAR_REQUEST_DATE = "//*[@id='ui-datepicker-div']//select[@class='ui-datepicker-year']";
	public static final String DATE_REQUEST_DATE = "//*[@id='ui-datepicker-div']/table/tbody/tr[1]/td[2]/a";
	public static final String PLANNED_START_DATE_PICKER = "//*[@id=\"P89_START_DATE_CONTAINER\"]/div[2]/div/button";
	public static final String MONTH_PLANNED_START_DATE = "//*[@id=\"ui-datepicker-div\"]//select[@class='ui-datepicker-month']";
	public static final String YEAR_PLANNED_START_DATE = "//*[@id='ui-datepicker-div']//select[@class='ui-datepicker-year']"; 
	...
	public static final String PARENT_MILESTONE_CR_OPTION1 = "//td[contains(text(),'MilestoneIDToBeReplaced')]";
	...
	public static final String CLOSENOTIFICATION_CR_BUTTON = "//*[@id='wwvFlowForm']/div[3]//button";
	...
	public static final String ADD_MILESTONE_PAGE_ADD_BUTTON = "//button[@id='B544932878788095505']";
	...
	public static final String CANCEL_CR_BUTTON = "//button[text()='Create']//preceding::button[1]";
	...
	public static final String SAVE_CHANGES_BUTTON_CR = "//button[@id='savedata']";
	...
	public static final String REASON_CODE_DRPDOWN_OPTLIst = "//li[contains(@class,\"a-IconList-item\")]";
	public static final String UPDATE_MILESTONE_OPTLIst = "//li[contains(@class,\"a-IconList-item\")]";
	public static final String PERC_COMPLETION_TXTBOX = "//input[contains(@id,\"P95_PCT_DONE\")]";
	public static final String STATUS_UPDATE_TXTBOX = "//textarea[contains(@id,\"P95_STATUS_UPDATE\")]";
	public static final String REASON_CODE_OPTION = "//li[text()='###']";
	public static final String ADDMILESTONE_POPUP_ERRORMSG = "//div[contains(@id,'_error')]";
	public static final String MILESTONE_NAME_ERRORMSG = "//*[@id=\"P59_DESCRIPTION_error\"]";
	public static final String CLOSE_NOTIFICATION = "//*[contains(@title,'Close Notification')]";
	public static final String MILESTONEIDS_LIST_WITH_OPENSTATUS = "//td[contains(@headers,'TASK_NUMBER')]//following-sibling::td//span[contains(text(),'Open')]";
	public static final String MILESTONEIDSLIST = "//td[contains(@headers,'TASK_NUMBER')]//span";
	public static final String CANCELMILESTONEPOPUP = "//*[@id='t_PageBody']/div[12]//button";
	...
	public static final String ADDED_RELEASE_STATUS ="(//span[@title='MilestoneIDToBeReplaced'])[1]//following::td[6]//span[2]";
	...
	public static final String OK_SPRINT_BUTTON = "//button[normalize-space()='OK']";
	// Sprint locators
	...
	public static final String ID_LBL_RELEASE_PHASE_TASK = "//label[contains(@id,'P83_TASK_NUMBER_LABEL')]";
	public static final String CR_PLANNED_START_DATE_CALENDAR = "//*[text()='Planned Start Date ']//following::input[1]";
