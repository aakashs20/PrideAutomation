...
public class CommonPagesConstants {
  ...
  //*[@id="PopupLov_63_P63_ROLE_TYPE_dlg"]/div[3]/div/div[3]/ul/li[1]
    ...
    //public static final String VERF_Role= "//*[@id='PopupLov_63_P63_ROLE_TYPE_dlg']/div[3]/div/div[3]/ul/li[2]";
   ...
   // public static final String SELECT_NUMBER_OF_RESOURCES= "//input[@id='P63_TOTAL_RESOURCES']";
...
//    public static final String VERF_NUMBER_OF_RESOURCES= "//td[text()='02-AUG-2022']";
   ...
   // public static final String BTN_ADD_ROLE="//button[@id=\'ADD_ROLE\']";  
    ...
    // class="t-Button t-Button--noLabel t-Button--icon t-Button--link"><span class="t-Icon fa fa-edit" aria-hidden="true"></span></button>
