...
import com.project.pTracker.Utils.*;
...
public class DeliveryMilestonePageTab extends TestBase{
	...
	public void createChangeRequest(WebDriver driver) throws Exception
	{
		...
		driver.findElement(By.xpath(DeliveryMilestoneConstants.CHANGE_REQUEST_NUMBER)).sendKeys(changeRequestNumberStr); // add random number
		threadsleep(1000);
		...
		controlActions.selectDropDownValue("2022", yearRequestDate);
		...
		threadsleep(500);
		logInfo("radio button paymentMilestonNo is displayed: " +controlActions.isElementDisplayed(paymentMilestoneNo));
	...
	public String checkListMilestone(WebDriver driver) throws Exception
	{
		...
		List<WebElement> elementList = driver.findElements(By.xpath(DeliveryMilestoneConstants.CHANGE_REQUEST_NUMBER_COLUMN));
	...
	public void editDeliveryMilestone(WebDriver driver) throws InterruptedException
	{
		...
		threadsleep(8000);	
		controlActions.click(driver.findElement(By.xpath("//*[@id='report_table_myRegion']/tbody/tr["+tableIndecxVar+"]/td[10]/button[1]")));
	...
	public boolean createDuplicateChangeRequest(WebDriver driver)
	{
		...
		driver.switchTo().frame(driver.findElement(By.xpath(DeliveryMilestoneConstants.IFRAME_CHANGE_REQUEST)));
		logInfo("ChangeRequestNumber is displayed: "+controlActions.isElementDisplay(changeRequestNumber));
		driver.findElement(By.xpath(DeliveryMilestoneConstants.CHANGE_REQUEST_NUMBER)).sendKeys(changeRequestNumberStr); // same change request number
		threadsleep(1000);
		logInfo("ChangeRequestType is displayed: "+controlActions.isElementDisplay(changeRequestType));
		controlActions.click(changeRequestType);
	...
	public boolean addPaymentMilestoneCR(WebDriver driver, int tcRowNum, String paymentMilestoneNm, String amount) throws Exception
	{
		try {
		rn = new Random();
		int result = rn.nextInt(10000-1000)+1000;
		...
		threadsleep(500);
		logInfo("Radio button paymentMilestonYes is displayed: " +controlActions.isElementDisplayed(paymentMilestoneYes));
		...
		threadsleep(2000);
		logInfo("Clicking on -> " + driver.findElement(By.xpath("//*[@id='pyment-mlstn_tab']/a[@aria-selected='true']")).isDisplayed());
