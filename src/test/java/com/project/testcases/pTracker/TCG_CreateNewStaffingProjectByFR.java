...
public class TCG_CreateNewStaffingProjectByFR extends TestBase {
	...
	public void createNewStaffingProjectByFR() throws Exception {
		...
		tcRowNum = ExcelUtils.getRowNum(datapoolPath,"Automation","testCase","TC_CREATE_NEW_STAFFING_PROJECT_BY_FR");
