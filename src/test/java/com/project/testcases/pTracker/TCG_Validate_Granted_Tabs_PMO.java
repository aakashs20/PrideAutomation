...
public class TCG_Validate_Granted_Tabs_PMO extends TestBase {
	...
	@Test(groups = {"sanity", "UI"}, description = "Validate Project Granted Tabs for PMO")
	public void validatePMO() throws Exception {
		String workspace = System.getProperty("user.dir");
		String datapoolPath = workspace+"\\test-data-files\\UI-TestData\\TC_CreateFixedPriceNewProject.xls";
		String sheetName = "Automation";
		loginPage =new PTrackerLoginPage(driver);
		tcRowNum = ExcelUtils.getRowNum(datapoolPath,sheetName,"testCase","TC_VALIDATE_GRANTED_PROJECT_TAB_PMO");
		...
		String value = rowData.get("ProjectManager");
		//String value=excelUtils.getRowValue(62, 66);
		logInfo(value);
	    loginPage.TC_PTrack_ChangeUser(driver, value);
		loginPage.goToPTrack("");
		loginPage.searchPTrackProjects(driver, "Release 12 - Project Management"); //PMO
