...
public class TCG_SubmitNewStaffingProject extends TestBase {
	...
	public void submitNewStaffingProject() throws Exception {
		...
		tcRowNum = ExcelUtils.getRowNum(datapoolPath,"Automation","testCase","TC_SUBMIT_NEW_STAFFING_PROJECT");
